...
export const wordSets: WordSet[] = [
  ...
  // ==========================================
  {
    ...
    words: [
      ...
      "dissertation", "education", "enrollment", "examination", "experiment",
  ...
  // ==========================================
  {
    ...
    category: "Money",
    words: [
      "annuity", "budget", "cash", "check", "coupon", "credit", "debt",
  ...
  },
  {
    ...
    words: [
      ...
      "tomato", "vegetable", "vegetarian", "vinegar", "vitamin", "yogurt", "yolk",
    ],
  },
  ...
  // ==========================================
  {
    ...
    words: [
      ...
      "crossing", "east", "entrance", "exit", "footbridge", "intersection",
  ...
  },
  {
    ...
    category: "Places",
    words: [
      "airport", "aquarium", "barracks", "cathedral", "cemetery", "church",
      "cinema", "clinic", "consulate", "courthouse", "embassy", "factory",
      "fountain", "gallery", "gymnasium", "hospital", "laboratory", "library",
      "lighthouse", "monastery", "monument", "mosque", "museum", "observatory",
      "parliament", "pharmacy", "planetarium", "police", "prison", "restaurant",
      "stadium", "statue", "synagogue", "temple", "theater", "university",
      "warehouse",
    ],
  },
  ...
  // ==========================================
  {
    ...
    words: [
      "acquisition", "adolescence", "analysis", "approach", "appropriate",
      "assessment", "authority", "bibliography", "bureaucracy", "coherent",
      "comprehensive", "contemporary", "controversial", "correspondence",
      "criteria", "curriculum", "differentiate", "discrimination",
      "empirical", "evaluation", "hierarchy", "hypothesis", "ideology",
      "implementation", "implications", "infrastructure", "interpretation",
      "investigation", "legitimate", "methodology", "miscellaneous",
      "occurrence", "paradigm", "participation", "perception", "phenomenon",
      "predominantly", "preliminary", "proportion", "qualitative",
      "quantitative", "significance", "subsequent", "surveillance",
      "sustainable", "theoretical", "transformation", "underlying", "validity",
    ],
  },
  {
    id: "connectors",
    name: "Connectors & Discourse Markers",
    category: "Academic Writing",
    words: [
      "accordingly", "albeit", "alternatively", "approximately",
      "consequently", "conversely", "essentially", "furthermore",
      "hence", "however", "inadvertently", "increasingly", "inevitably",
      "meanwhile", "moreover", "nevertheless", "nonetheless",
      "notwithstanding", "otherwise", "particularly", "predominantly",
      "simultaneously", "specifically", "subsequently", "thereby",
      "therefore", "thus", "ultimately", "undoubtedly", "whereas",
    ],
  },
  {
    id: "tion-sion",
    ...
    words: [
      "accommodation", "acquisition", "administration", "appreciation",
      "authorization", "civilization", "collaboration", "communication",
      "comprehension", "concentration", "consideration", "contribution",
      "coordination", "demonstration", "determination", "discrimination",
      "discussion", "distribution", "documentation", "elimination",
      "examination", "explanation", "extension", "fascination",
      "globalization", "identification", "illustration", "immigration",
      "improvisation", "interpretation", "investigation", "justification",
      "legislation", "modification", "negotiation", "observation",
      "organization", "participation", "permission", "persuasion",
      "possession", "presentation", "procrastination", "pronunciation",
      "provision", "publication", "qualification", "recommendation",
      "recognition", "rehabilitation", "representation", "resignation",
      "revision", "submission", "supervision", "suspension",
      "transmission", "vaccination", "visualization",
    ],
  },
  ...
  // ==========================================
  {
    ...
    words: [
      ...
      "ancient", "annuity", "anxiety",
      "argument", "ascertained", "assess", "assessed", "athlete", "autumn", "available",
      "background", "beginning", "believe", "beneficial", "bedsit", "bookstore", "boundaries",
      "brakes", "brass", "business",
      "cabins", "calcium", "canteen", "category", "cathedral", "ceiling", "chemistry", "cigar",
      "circumstances", "classroom", "climate", "cloudy", "colonel", "colonization",
      "column", "committee", "conceive", "concisely", "conscience", "conscious",
      "convenient", "countryside", "criticism",
      "debt", "deceive", "definitely", "definite", "development",
      "desert", "dessert", "difficult", "disappear", "disappoint",
      ...
      "interference", "interrupt", "intricacies", "island",
      "judgment", "keyboard", "knowledge",
      ...
      "necessary", "neither", "niece", "non-refundable", "noticeable", "notebook",
      "occurrence", "opportunity", "ottoman",
      "parallel", "passenger", "passport", "pavement", "pedestrian", "perceive",
      "persuade", "pharaoh", "physics", "possession", "possible",
      "postbox", "potassium", "poultry", "preference", "pressure", "privilege", "process",
      "professional", "pronounce", "pronunciation", "psychology",
      "questionnaire",
      "raincoat", "rainwear", "receipt", "receive", "recommend", "reference", "relief",
      "restaurant", "rhyme", "rhythm", "rural",
      "sable", "science", "scientist", "scissors", "seasick", "seaside",
      "separate", "sign", "sneakers", "speech",
      "significant", "standardization", "success", "sufficient", "suggestion", "sunshade",
      "support", "swallowing",
      "technique", "teeming", "temperature", "temporarily", "tendency", "tennis",
      "textbook", "thesis", "thief", "thorough", "throughout",
      "traffic", "trivial", "truly", "twelfth",
      "umbrella", "unconscious", "unfortunate", "unfortunately", "unforeseen",
      "university", "unnecessary", "urban",
      "vegetarian", "vehicle", "village", "volcanic", "volunteer",
      "waterfall", "whale",
      ...
      "confirmation", "destination", "equipment", "inquiry",
...

  {
    ...
    words: [
      ...
      "colonel", "heir", "honest", "honor", "hour",
...

  {
    ...
    words: [
      ...
      "parallel", "possession", "program", "success", "supposed",
      "tomorrow", "unnecessary", "broccoli", "cappuccino", "diarrhea",
      "disappear", "dissatisfied", "excellent", "happiness", "interrupt",
      "jewelry", "misspell", "occasion", "questionnaire", "satellite",
  ...
  // ==========================================
  {
    ...
    hints: {
      ...
      "knight":     "an armored soldier in medieval times",
      ...
      "some":       "an unspecified amount - not a math total",
      "sum":        "a total, or a math calculation",
    },
  },
];
