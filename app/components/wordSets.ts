...
export const wordSets: WordSet[] = [
  ...
  },
  {
    ...
    words: [
      ...
      "tomato", "vegetable", "vegetarian", "vitamin", "yogurt", "yolk",
    ],
  },
  ...
  // ==========================================
  {
    ...
    words: [
      ...
      "ascertained", "assess", "assessed", "athlete", "autumn", "available",
      ...
      "faculty", "field", "foreign",
      "friend", "fundamental", "fundraising",
      ...
      "separate", "sign", "sneakers", "software", "speech",
      "standardization", "success", "sufficient", "suggestion", "sunshade",
      "support", "swallowing",
      "technique", "teeming", "temperature", "temporarily", "tennis",
