...
export const wordSets: WordSet[] = [
...

  {
    ...
    hints: {
      "achieve":      "i before e — a-c-h-i-e-v-e",
      "believe":      "i before e — b-e-l-i-e-v-e",
      "relieve":      "i before e — r-e-l-i-e-v-e",
      "retrieve":     "i before e — r-e-t-r-i-e-v-e",
      "grieve":       "i before e — g-r-i-e-v-e",
      "reprieve":     "i before e — r-e-p-r-i-e-v-e",
      "brief":        "i before e — b-r-i-e-f",
      "chief":        "i before e — c-h-i-e-f",
      "field":        "i before e — f-i-e-l-d",
      "grief":        "i before e — g-r-i-e-f",
      "piece":        "i before e — p-i-e-c-e",
      "pierce":       "i before e — p-i-e-r-c-e",
      "priest":       "i before e — p-r-i-e-s-t",
      "shield":       "i before e — s-h-i-e-l-d",
      "siege":        "i before e — s-i-e-g-e",
      "thief":        "i before e — t-h-i-e-f",
      "yield":        "i before e — y-i-e-l-d",
      "niece":        "i before e — n-i-e-c-e",
      "fierce":       "i before e — f-i-e-r-c-e",
      "fiend":        "i before e — f-i-e-n-d",
      "receive":      "e before i after c — r-e-c-e-i-v-e",
      "deceive":      "e before i after c — d-e-c-e-i-v-e",
      "conceive":     "e before i after c — c-o-n-c-e-i-v-e",
      "perceive":     "e before i after c — p-e-r-c-e-i-v-e",
      "ceiling":      "e before i after c — c-e-i-l-i-n-g",
      "receipt":      "e before i after c, silent p — r-e-c-e-i-p-t",
      "neither":      "exception — e before i, not after c",
      "leisure":      "exception — e before i, not after c",
      "seize":        "exception — e before i, not after c",
      "weird":        "exception — e before i, not after c",
      "protein":      "exception — e before i, not after c",
      "caffeine":     "exception — e before i, not after c",
      "species":      "exception — e before i, not after c",
      "height":       "exception — e before i, not after c",
      "freight":      "exception — e before i, not after c",
      "weight":       "exception — e before i, not after c",
      "eight":        "exception — e before i, not after c",
      "surveillance": "e before i after c — sur-veil-lance",
    },
  },
