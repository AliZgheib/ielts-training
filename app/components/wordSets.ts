...
export const wordSets: WordSet[] = [
  ...
  // ==========================================
  {
    ...
    words: [
      ...
      "exaggerate", "excellent", "exhibit", "exhibition",
  ...
  // ==========================================
  {
    ...
    words: [
      ...
      "chemistry", "climate", "cloudy", "colonization",
      ...
      "sunshade", "swallowing", "taps", "teeming", "temporarily",
      "tennis", "thesis", "trainers", "trivial", "umbrella", "urban",
      "vegetarian", "volcanic", "waist", "whales", "winding", "wombat",
      "yoghurt", "yolk",
      "adolescence", "ascertained", "circumstances", "concisely", "conscious", "unconscious", "disappear", "dissemination",
  ...
  // ==========================================
  {
    ...
    words: [
      ...
      "excellent", "experience", "explanation", "field", "foreign",
