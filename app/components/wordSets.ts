...
export const wordSets: WordSet[] = [
  ...
  // ==========================================
  {
    ...
    words: [
      ...
      "afternoon", "airport", "ancient", "annuity", "anxiety", "apartment",
      ...
      "database", "daytime", "debt", "deceive", "definite", "design",
      ...
      "midafternoon", "midday", "midevening", "midlife", "midmorning", "midnight",
      "midmonth", "midpoint", "midsection", "midstream", "midway", "midweek", "midyear",
      "mortgage", "motto", "museum",
      "necessary", "neither", "niece", "non-refundable", "notebook",
      "occurrence", "opportunity", "ottoman", "overnight",
  ...
  // ==========================================
  {
    ...
    hints: {
      "council":    "a group that makes decisions (city council)",
      "counsel":    "advice, or a lawyer (legal counsel)",
      ...
      "whether":    "used to introduce two options (whether or not)",
      ...
      "principle":  "a rule or belief (moral principle)",
      ...
      "coarse":     "rough in texture (coarse sand)",
      "course":     "a path, or a class you study (golf course)",
      ...
      "weak":       "not strong",
      "week":       "seven days",
      "whole":      "the complete amount (the whole cake)",
      ...
      "site":       "a location (building site, website)",
      "past":       "time before now (in the past)",
      "passed":     "went by, or succeeded (past tense of pass)",
      "role":       "a part someone plays (his role in the team)",
      "roll":       "to turn over, or a bread roll",
      "tale":       "a story",
      ...
      "serial":     "happening in a series (serial number)",
      ...
      "aloud":      "using your voice, out loud (read aloud)",
      ...
      "not":        "used to make a negative (I am not sure)",
      ...
      "for":        "in favour of, or because of (for you)",
      "four":       "the number 4",
      "wait":       "to stay until something happens",
      "weight":     "how heavy something is",
      "way":        "a route or method (on the way home)",
      "weigh":      "to measure how heavy something is",
      "wear":       "to have clothes on your body",
      "where":      "asking about a place (where are you?)",
      "wood":       "material from trees",
      "would":      "past of will, or a conditional (I would go)",
      "hour":       "60 minutes",
      "our":        "belonging to us (our house)",
      "two":        "the number 2",
      "too":        "also, or more than enough (too much)",
      "buy":        "to purchase something",
      "by":         "next to, or using (by the door / by hand)",
      "morning":    "the early part of the day",
      "mourning":   "grieving after someone has died",
      "knight":     "an armoured soldier in medieval times",
      "night":      "the dark part of the day",
      "heard":      "past tense of hear (I heard a noise)",
      "herd":       "a group of animals (a herd of cattle)",
      ...
      "seen":       "past participle of see (I have seen it)",
      ...
      "profit":     "money gained after costs (business profit)",
      ...
      "taut":       "pulled tight (a taut rope)",
      "taught":     "past tense of teach (she taught me)",
      "seam":       "a line of stitching joining two pieces of fabric",
      "seem":       "to appear to be (it seems fine)",
      "some":       "an unspecified amount (some water)",
